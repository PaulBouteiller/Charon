...
def gather_coordinate(V):
    ...
    # Pour les coordonnées, on compte les POINTS, pas les DOFs
    local_range = asarray(imap.local_range, dtype=int32)  # SANS * index_map_bs
    size_global = imap.size_global  # SANS * index_map_bs
