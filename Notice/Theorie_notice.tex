...
\end{pmatrix}$$
\begin{Rem}{\blue{Tout ces résultats peuvent se redémontrer facilement en permutant l'ordre des vecteurs de bases pour obtenir $\er,\ez,\etheta$. Dans cette base le tenseur a une forme par bloc beaucoup plus simple.}^}\end{Rem}
